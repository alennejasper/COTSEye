    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capture_date', models.DateTimeField(default=datetime.datetime(2024, 3, 24, 15, 3, 18, 400566), help_text='Designates the capture date and time of the post.', verbose_name='Capture Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_photos', models.ForeignKey(blank=True, help_text='Designates the foreign key of the Post Photos model.', null=True, on_delete=django.db.models.deletion.CASCADE, to='reports.postphoto', verbose_name='Post Photo')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='post',
            name='post_photos',
            field=models.ManyToManyField(blank=True, help_text='Designates the foreign key of the Post Photo model.', null=True, through='reports.PostGallery', to='reports.postphoto', verbose_name='Post Photos'),
        ),
        migrations.AddField(
            model_name='post',
            name='post_status',
