    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capture_date', models.DateTimeField(default=datetime.datetime(2024, 4, 26, 1, 36, 49, 832786), help_text='Designates the capture date and time of the post.', verbose_name='Capture Date')),
