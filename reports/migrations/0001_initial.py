    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capture_date', models.DateTimeField(default=datetime.datetime(2024, 4, 16, 13, 15, 6, 546351), help_text='Designates the capture date and time of the post.', verbose_name='Capture Date')),
