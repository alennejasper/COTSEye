    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capture_date', models.DateTimeField(default=datetime.datetime(2024, 5, 14, 6, 35, 17, 896180), help_text='Designates the capture date and time of the post.', verbose_name='Capture Date')),
