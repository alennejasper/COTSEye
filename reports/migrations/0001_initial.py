    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('density', models.IntegerField(blank=True, help_text='Designates the density of the Crown-of-Thorns Starfish at the moment the post taken.', null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Density')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capture_date', models.DateTimeField(default=datetime.datetime(2024, 3, 7, 21, 0, 14, 555043), help_text='Designates the capture date and time of the post.', verbose_name='Capture Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(blank=True, help_text='Designates the foreign key of the Post model.', null=True, on_delete=django.db.models.deletion.CASCADE, to='reports.post', verbose_name='Post')),
                ('post_photos', models.ForeignKey(blank=True, help_text='Designates the foreign key of the Post Photos model.', null=True, on_delete=django.db.models.deletion.CASCADE, to='reports.postphotos', verbose_name='Post Photos')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='post',
            name='post_photos',
            field=models.ManyToManyField(blank=True, help_text='Designates the foreign key of the Post Photos model.', null=True, through='reports.PostGallery', to='reports.postphotos', verbose_name='Post Photos'),
        ),
        migrations.AddField(
            model_name='post',
            name='post_status',
            field=models.ForeignKey(blank=True, default=1, help_text='Designates the foreign key of the Post Status model.', null=True, on_delete=django.db.models.deletion.CASCADE, to='reports.poststatus', verbose_name='Post Status'),
        ),
    ]
