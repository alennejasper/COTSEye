    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joined_date', models.DateTimeField(default=datetime.datetime(2024, 6, 4, 15, 2, 39, 294285), help_text='Designates the joined date and time of the user.', verbose_name='Joined Date')),
