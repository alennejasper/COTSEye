    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joined_date', models.DateTimeField(default=datetime.datetime(2024, 5, 14, 6, 35, 17, 880554), help_text='Designates the joined date and time of the user.', verbose_name='Joined Date')),
