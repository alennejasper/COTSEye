    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joined_date', models.DateTimeField(default=datetime.datetime(2024, 3, 24, 15, 3, 18, 391590), help_text='Designates the joined date and time of the user.', verbose_name='Joined Date')),
