    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joined_date', models.DateTimeField(default=datetime.datetime(2024, 3, 7, 21, 0, 14, 546067), help_text='Designates the joined date and time of the user.', verbose_name='Joined Date')),
