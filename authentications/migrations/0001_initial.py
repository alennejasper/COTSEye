    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='Designates the foreign key of the Group model.', to='auth.group', verbose_name='Groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Designates the foreign key of the Permission model.', to='auth.permission', verbose_name='User Permissions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joined_date', models.DateTimeField(default=datetime.datetime(2024, 3, 1, 14, 47, 56, 452098), help_text='Designates the joined date and time of the user.', verbose_name='Joined Date')),
