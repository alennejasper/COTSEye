    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='Designates the foreign key of the Group model.', null=True, to='auth.group', verbose_name='Groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Designates the foreign key of the Permission model.', null=True, to='auth.permission', verbose_name='User Permissions')),
                ('usertype', models.ForeignKey(help_text='Designates the foreign key of the User Type model.', on_delete=django.db.models.deletion.CASCADE, to='authentications.usertype', verbose_name='User Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(help_text='Designates the phone number of the user.', max_length=10, null=True, verbose_name='Phone Number')),
                ...
                ('joined_date', models.DateTimeField(default=datetime.datetime(2024, 3, 25, 14, 53, 14, 617633), help_text='Designates the joined date and time of the user.', verbose_name='Joined Date')),
