    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joined_date', models.DateTimeField(default=datetime.datetime(2024, 3, 26, 19, 46, 34, 695528), help_text='Designates the joined date and time of the user.', verbose_name='Joined Date')),
