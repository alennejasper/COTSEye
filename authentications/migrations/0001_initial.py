    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('joined_date', models.DateTimeField(default=datetime.datetime(2024, 3, 25, 20, 46, 23, 150125), help_text='Designates the joined date and time of the user.', verbose_name='Joined Date')),
